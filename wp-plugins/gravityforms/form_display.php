...
class GFFormDisplay {
	...
	public static function maybe_add_review_page( $form_id ) {
		...
		$review_page = array(
			'button_text' => __( 'Review Form', 'gravityforms' ),
			'content'     => '',
			'is_enabled'  => false
		);
	...
	public static function process_form( $form_id ) {
		...
		$form = self::maybe_add_review_page( $form_id );
	...
	public static function insert_review_page( $form, $review_page ) {
		...
		/* Get Review Page button text. */
		$button_text = rgar( $review_page, 'button_text' );
		...
		$review_page_break->nextButton     = self::get_form_button( $form['id'], "gform_next_button_{$form['id']}_{$review_page_break->id}", array( 'type' => 'text', 'text' => $button_text ), $button_text, 'gform_next_button', $button_text, $review_page_break->pageNumber );
